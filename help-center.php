...
<head>
  ...
  <title>Help Center | Coin Trade</title>
    ...
    <section class="page-section">
      ...
      <div class="page-grid">
        ...
        <article class="card">
          ...
          <p>Supported networks, fee breakdowns, and payout schedules.</p>
        </article>
        <article class="card">
          <h4>Security &amp; compliance</h4>
          <p>Device approvals, API key management, and compliance reviews.</p>
        </article>
      </div>
    </section>

    <section class="page-section">
      <h2 class="section-title">Guided walkthroughs</h2>
      <div class="page-grid">
        <article class="card">
        ...
        <article class="card">
          ...
          <p>Enable multi-factor authentication and set withdrawal allowlists.</p>
        </article>
        <article class="card">
          <h4>Monitor live earnings</h4>
          <p>Use the analytics view to compare daily, weekly, and monthly yields.</p>
        </article>
      </div>
    </section>
